        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title float-left">Data Tarif</h4>
                                <p class="card-description float-right">
                                       <b-button variant="success" v-b-modal.modalTarif v-on:click="Add"><i class="mdi mdi-plus btn-icon-prepend"></i> Tambah</b-button>
                                     </p>
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-hover progress-table text-center">
                                            ...
                                            <b-table striped hover :items="tarif" :fields="fields">
                  <!-- <template v-slot:cell(role)="data">
                    <b-badge variant="warning">{{ data.item.role }}</b-badge>
                  </template> -->
                                      <template v-slot:cell(Aksi)="data">
                                        <b-button size="sm" variant="info" v-on:click="Edit(data.item)" v-b-modal.modalTarif><i class="mdi mdi-pencil btn-icon-prepend"></i> Ubah</b-button>&nbsp;
                           ...
                           <template v-slot:modal-title>
                             ...
                             <form ref="form">
                               <div class="form-group">
                                 <input type="number" name="daya" class="form-control" id="daya" placeholder="Daya" v-model="daya">
                               </div>
                               <div class="form-group">
                                 <input type="number" name="tarifperkwh" class="form-control" id="tarifperkwh" placeholder="Tarif per kwh" v-model="tarifperkwh">
                               </div>
                             </form>
                         </b-modal>
...
module.exports = {
  data : function(){
    return {
      ...
      key: "",
      siswa: [],
      fields: ["id", "daya", "tarifperkwh", "Aksi"],
    }
  },
  computed : {
  ...
  methods: {
    ...
    getData : function(){
      ...
      this.axios.get("/tarif/" + this.perPage + "/" + offset, conf)
      .then(response => {
        if(response.data.status == 1){
          ...
          this.$bvToast.hide("loadingToast");
          this.message = "Gagal menampilkan data tarif."
    ...
    Edit : function(item){
      ...
      this.id = item.id;
      this.daya = item.daya;
      this.tarifperkwh = item.tarifperkwh;
    ...
    Save : function(){
      ...
      if(this.action === "insert"){
        ...
        form.append("daya", this.daya);
        form.append("tarifperkwh", this.tarifperkwh);


        this.axios.post("/tarif", form, conf)
        .then(response => {
          this.$bvToast.hide("loadingToast");
          if(this.search == ""){
            this.getData();
        ...
        this.axios.put("/tarif/" + this.id, form, conf)
        .then(response => {
          this.$bvToast.hide("loadingToast");
          if(this.search == ""){
            this.getData();
    ...
    Drop : function(id){
      ...
      if(confirm('Apakah anda yakin ingin menghapus data ini?')){
        this.$bvToast.show("loadingToast");
        this.axios.delete("/tarif/" + id, conf)
        .then(response => {
            this.getData();
            this.$bvToast.hide("loadingToast");
            this.message = response.data.message;
