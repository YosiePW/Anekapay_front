        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title float-left">Data User</h4>
                           ...
                           <template v-slot:modal-title>
                             ...
                             <form ref="form">
                               <div class="form-group">
                                 <input type="text" name="nama_user" class="form-control" id="nama_user" placeholder="Nama User" v-model="nama_user">
                               </div>
                               <div class="form-group">
...
module.exports = {
  data : function(){
    return {
      ...
      key: "",
      siswa: [],
      fields: ["id", "nama_user", "email", "password", "Aksi"],
    }
  },
  computed : {
  ...
  methods: {
    ...
    getData : function(){
      ...
      this.axios.get("/user/" + this.perPage + "/" + offset, conf)
      .then(response => {
    ...
    Save : function(){
      ...
      if(this.action === "insert"){
        ...
        form.append("nama_user", this.nama_user);
    ...
    Drop : function(id){
      ...
      if(confirm('Apakah anda yakin ingin menghapus data ini?')){
        this.$bvToast.show("loadingToast");
        this.axios.delete("/user/" + id, conf)
        .then(response => {
            this.getData();
            this.$bvToast.hide("loadingToast");
            this.message = response.data.message;
